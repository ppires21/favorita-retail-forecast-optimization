...
#s_d11, s_d12, s_e11, s_e12, s_b11, s_b12
pred_sales <- matrix(c(
  790, 525, 274,  42, 811, 224,
  700, 432, 460,  70, 694, 199,
  658, 405, 574,  53, 673, 180,
  650, 467, 213,  72, 591, 188,
  565, 389, 179,  76, 690, 161,
  533, 388, 237, 65, 699, 169,
  538, 384, 210,  54, 612, 171
), nrow = 7, byrow = TRUE)

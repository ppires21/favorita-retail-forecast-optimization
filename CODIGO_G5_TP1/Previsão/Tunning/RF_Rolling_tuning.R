...
grid <- expand.grid(
  lag_window = c(7, 15, 30),    # nº de lags
  increment  = c(7, 14),        # passo da rolling window
  Runs       = c(10, 20, 30),  # iterações de CV rolling

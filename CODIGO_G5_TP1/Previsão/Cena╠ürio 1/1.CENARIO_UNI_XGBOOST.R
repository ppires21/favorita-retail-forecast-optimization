...
melhores_params <- list(
  s_d11 = list(eta = 0.05, max_depth = 6, nrounds = 50),    # NMAE = 22.965
  s_d12 = list(eta = 0.10, max_depth = 6, nrounds = 200),   # NMAE = 30.118
  s_e11 = list(eta = 0.05, max_depth = 4, nrounds = 50),    # NMAE = 41.159
  s_e12 = list(eta = 0.05, max_depth = 6, nrounds = 50),    # NMAE = 40.421
  s_b11 = list(eta = 0.05, max_depth = 6, nrounds = 50),    # NMAE = 19.965
  s_b12 = list(eta = 0.20, max_depth = 5, nrounds = 150)    # NMAE = 12.403
)
...
for (col in sales_cols) {
  ...
  plot(
    ...
    type = "b", pch = 16,
    xlab = "Dia", ylab = "Valor",
    main = paste("XGBoost optimizado –", col),
